// import { ClientConfig, WorkerConfig, makeClient, Persistence } from "./index";
...
//     expect(persistence.claim).toHaveBeenCalledWith(now, timeout);
//   });
// });
...
//     expect(persistence.findOutput).toHaveBeenCalledWith("workflow-1", "step-1");
//   });
...
//     expect(persistence.updateOutput).toHaveBeenCalledWith(
//       "workflow-1",
//       "step-1",
//       "output-1",
//       timeoutAt,
...
//     expect(persistence.findWakeUpAt).toHaveBeenCalledWith(
//       "workflow-1",
//       "nap-1",
//     );
//   });
